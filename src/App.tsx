...
function Hero() {
  return (
    <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '110px 24px 60px', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
      ...
      <div className="grid-2col" style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 56, alignItems: 'center' }}>
        <div>
          ...
          <motion.h2 {...fw(0.06)} style={{ fontSize: 'clamp(24px,3.5vw,38px)', fontWeight: 800, lineHeight: 1.12, marginBottom: 18, letterSpacing: '-0.03em' }}>
            Se você está assim,<br /><span style={{ color: 'rgba(255,255,255,0.22)' }}>você não está sozinho.</span>
          </motion.h2>
